...
void loop() {
	...
	String VarTfL_Left = String(TfL_Get(tfAddr1));	//<data> - replace these lines with data from sensors
	String VarTfL_Mid = String(TfL_Get(tfAddr2));
	String VarTfL_Right = String(TfL_Get(tfAddr3));
	String VarSharp_Left = String(0);
	String VarSharp_Right = String(0);
	String VarQRE_Left = String(LINE_Get(1, 3000));
	String VarQRE_Rear = String(LINE_Get(4, 3000));
	String VarQRE_Right = String(LINE_Get(3, 3000));	//</data> - up to here
