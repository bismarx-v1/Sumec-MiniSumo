...
WiFiAPStuff AP;	// init my AP lib
WiFiUDP udp;	// init the udp lib
...
const uint8_t bufferLen = 32;	// the max length of the packets in bytes
char buffer[bufferLen];
uint8_t bufferUint8[bufferLen];

uint32_t PacketNum = 0;	// packet counter
