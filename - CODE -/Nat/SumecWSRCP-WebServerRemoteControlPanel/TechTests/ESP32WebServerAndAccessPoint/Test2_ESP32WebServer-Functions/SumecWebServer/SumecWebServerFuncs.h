	...
	switch(type) {
		...
		case WStype_TEXT:
			...
			if(error) {
				...
				const char* RunButton = doc_rx["Button_Run"];
				const int ModeVar = doc_rx["Select_mode"];
...
//..//    Prep Code    //
//./////////////////////
void SumecWebServer_UpdatePrep() {
	String jsonString = "";
...
void SumecWebServer_Update(String UpdateVar, int UpdateVarValue) {
	object[String(UpdateVar)] = UpdateVarValue;
}
...
//..//    Send Code    //
//./////////////////////
void SumecWebServer_UpdatePush() {
