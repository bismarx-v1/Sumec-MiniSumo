...
void loop() {
  Serial.println(String(LASER_Get(1, 500)));  //pravy senzor (1) z pohledu sumce
  Serial.println(String(LASER_Get(3, 500)));  //prostredni senzor (3) z pohledu sumce
  Serial.println(String(LASER_Get(2, 500)));  //levy senzor (2) z pohledu sumce
  Serial.print("======================== \n");
  delay(1000);
}
